...
<body>
	<center>
		<h4>
			<a href="${pageContext.request.contextPath}/EmployeeServlet?action=list">List
				All Employees</a>
		</h4>
	</center>
	<div align="center">
		...
		<table border="1" cellpadding="5">
			...
			<c:if test="${employee != null}">
				<input type="hidden" name="id"
					value="<c:out value='${employee.getEid()}' />" />
			</c:if>
			<tr>
				<th>Employee Name:</th>
				<td><input type="text" name="name" size="45" required
					value="<c:out value='${employee.getEname()}' />" /></td>
			</tr>
			<tr>
				<th>Age:</th>
				<td><input type="number" name="age" min="10" required
					value="<c:out value='${employee.getEage()}' />" /></td>
			</tr>
			<tr>
